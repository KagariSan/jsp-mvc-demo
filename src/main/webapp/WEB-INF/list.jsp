...
<jsp:useBean id="model"
	class="com.itplus.test1.model.EmployeeModel" scope="session"></jsp:useBean>
	...
	<c:if test="true">
		...
		<div class="panel" id="panel1">
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<c:forEach items="${model.getListEmployee()}" var="employee">
						...
						<td>
							<form action="" method="post" onsubmit="return validateForm()">
								...
								<input
									type="submit" class="btn btn-primary" name="submit" value="DELETE">
							</form>
